        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasMaterial = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedMaterial = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedMaterial = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "Index_Unique_Package_Product",
                table: "PackageItems",
            ...
            migrationBuilder.CreateIndex(
                name: "Index_Package_Available_Date",
                table: "Packages",
                columns: new[] { "IsAvilable", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "Index_ProductImage_ProductId",
                table: "ProductImages",
                column: "ProductId");
